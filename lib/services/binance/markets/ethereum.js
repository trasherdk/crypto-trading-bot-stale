const ethereum = {
    ...
    minBuyOrderVolume: 100.00, // minimum BUY order volume to allocate in notional currency (BUSD)
    minSellOrderVolume: 100.00, // minimum SELL order volume to allocate in notional currency (BUSD)
