const ethereum = {
    ...
    buyAllocation: 0.1, // { 0-1 } how much of the base balance to allocate for the buy order
    sellAllocation: 0.1, // { 0-1 } how much of the asset balance to allocate for the sell order
