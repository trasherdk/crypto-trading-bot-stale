 ...
 * */
const WAVE_IMPACT_MULTIPLIER = 0.15;

const DELTA_SPREAD_MULTIPLIER = 2.75;
        ...
        if (buyOpenOrder !== null) {
            ...
            if (this.closedOrders.length > 0) {
                ...
                if (lastBuyOrder !== null && lastSellOrder !== null) {
                    ...
                    const spread = this.getBuySpread() * DELTA_SPREAD_MULTIPLIER;
        ...
        if (sellOpenOrder !== null) {
            ...
            if (this.closedOrders.length > 0) {
                ...
                if (lastBuyOrder !== null && lastSellOrder !== null) {
                    ...
                    const spread = this.getSellSpread() * DELTA_SPREAD_MULTIPLIER;
