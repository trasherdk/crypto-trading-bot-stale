...
const dogeConfig = {
    ...
    buySpread: 0.06, // { 0-1 } percentage of asset price fluctuation to trigger buy limit order
    sellSpread: 0.04, // { 0-1 } percentage of asset price fluctuation to trigger sell limit order
