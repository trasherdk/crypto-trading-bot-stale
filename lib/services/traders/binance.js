...
class Trader {
    ...
    getBuyOrder = () => {
        const buyPrice = this.price.bid * (1 - this.buySpread);
        const buyVolume = (this.baseBalance * this.buyAllocation) / this.price.bid;
    ...
    getSellOrder = () => {
        const sellPrice = this.price.ask * (1 + this.sellSpread);
