...
class Trader {
    ...
    tick = async () => {
        ...
        if (this.shouldBuy(buyOrder)) {
            ...
            console.log(`[${ this.market }] [...] should not BUY.`);
        }
        ...
        if (this.shouldSell(sellOrder)) {
            ...
            console.log(`[${ this.market }] [...] should not SELL.`);
        }
    };
    ...
    getSellOrder = () => {
        ...
        const increasedPrice = MIN_NOTIONAL_ORDER_VOLUME / sellVolume;
        ...
        if (
            ...
            && increasedPrice < sellPrice * 1.5
            && this.assetBalance > bareAssetMinimum
        ) {
            sellPrice = increasedPrice;
            totalToBeSold = MIN_NOTIONAL_ORDER_VOLUME;
        }
