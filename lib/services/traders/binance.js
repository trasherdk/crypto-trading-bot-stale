...
const DELTA_SPREAD_COEFFICIENT = 1.95;
        ...
        if (buyOpenOrder !== null) {
            ...
            if (this.closedOrders.length > 0) {
                ...
                if (lastClosedOrder.side === 'sell') {
                    ...
                    const delta2 = (order.buyPrice - buyOpenOrder.price) / order.buyPrice;
        ...
        if (sellOpenOrder !== null) {
            ...
            if (this.closedOrders.length > 0) {
                ...
                if (lastClosedOrder.side === 'buy') {
                    ...
                    const delta2 = (sellOpenOrder.price - order.sellPrice) / order.sellPrice;
