...
const MIN_ORDER_VOLUME = 10.50; // of crypto coins based on USD
...
class Trader {
    ...
    getBuyOrder = () => {
        ...
        if (totalToBeBought < MIN_ORDER_VOLUME) {
            totalToBeBought = MIN_ORDER_VOLUME;
    ...
    getSellOrder = () => {
        ...
        let sellPrice = this.price.ask * (1 + priceRise);
        ...
        if (totalToBeSold < MIN_ORDER_VOLUME) {
            totalToBeSold = MIN_ORDER_VOLUME;
