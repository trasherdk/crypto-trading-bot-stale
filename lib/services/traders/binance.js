...
const MIN_NOTIONAL_ORDER_VOLUME = 10.50;
...
class Trader {
    ...
    getSellOrder = () => {
        ...
        /** allow at least minimum sell order: increase price  (when there is enough asset balance left) */
        const bareAssetMinimum = totalToBeSold * MIN_NOTIONAL_ORDER_VOLUME * MIN_NOTIONAL_ORDERS_TO_KEEP;
        if (totalToBeSold < MIN_NOTIONAL_ORDER_VOLUME && this.assetBalance > bareAssetMinimum) {
            sellPrice = MIN_NOTIONAL_ORDER_VOLUME / sellVolume;
