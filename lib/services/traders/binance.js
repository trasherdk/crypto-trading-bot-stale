        ...
        if (buyOpenOrder !== null) {
            ...
            if (this.closedOrders.length > 0) {
                ...
                if (lastClosedOrder.side === 'sell') {
                    // between last closed SELL order & new BUY order
        ...
        if (sellOpenOrder !== null) {
            ...
            if (this.closedOrders.length > 0) {
                ...
                if (lastClosedOrder.side === 'buy') {
                    // between last closed BUY order & new SELL order
                    const delta1 = (lastClosedOrder.price - order.sellPrice) / order.sellPrice;

                    // between currently open SELL order & new SELL order
