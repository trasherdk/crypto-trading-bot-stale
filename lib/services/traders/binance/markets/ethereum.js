const ethereum = {
    ...
    minBuyOrderVolume: 30.00, // minimum BUY order volume to allocate in notional currency (BUSD)
    minSellOrderVolume: 50.00, // minimum SELL order volume to allocate in notional currency (BUSD)
