const ethereum = {
    ...
    minBuyOrderVolume: 75.00, // minimum BUY order volume to allocate in notional currency (BUSD)
    minSellOrderVolume: 75.00, // minimum SELL order volume to allocate in notional currency (BUSD)
