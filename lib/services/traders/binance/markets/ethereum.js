const ethereum = {
    ...
    minBuyOrderVolume: 150.00, // minimum BUY order volume to allocate in notional currency (BUSD)
    minSellOrderVolume: 150.00, // minimum SELL order volume to allocate in notional currency (BUSD)
