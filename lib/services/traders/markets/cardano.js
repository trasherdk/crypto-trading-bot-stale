const cardano = {
    ...
    sellAllocation: 0.085, // { 0-1 } how much of the asset balance to allocate for the sell order
    minBuyOrderVolume: 10.00, // minimum BUY order volume to allocate in notional currency (BUSD)
    minSellOrderVolume: 10.00, // minimum SELL order volume to allocate in notional currency (BUSD)
